...
CREATE TABLE `person` (
  ...
  `MCI` varchar(15) DEFAULT NULL,
  KEY `MCI` (`MCI`),
  CONSTRAINT `MCI` FOREIGN KEY (`MCI`) REFERENCES `phi` (`MCI`)
...
INSERT INTO `phi` VALUES ('1234','aaa','bbb','nikaweratiya','567-0987-765','bmnimashi@gmail.com','12345678\0\0\0\0\0\0\0\0'),('3456','kamala','uthpala','nikaweratiya','0776854326','bmnimashi@gmail.com','09876543');
...
-- Dump completed on 2021-05-24 21:39:31
